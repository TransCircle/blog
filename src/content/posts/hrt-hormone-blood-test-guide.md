...
> [!TIP] 监测频率建议
> 第一年约每 3 个月监测一次，水平稳定后可延长到每年 1–2 次[^1]。剂量变化、指标异常或出现新症状时，医生可能安排更密集的复查。
...
> [!NOTE] 提醒
> 自助开单只能用于检测便利，不等同于治疗方案评估。出现异常指标或需要调整方案时，应寻求医生帮助。
...
建议 GAHT 用药满三个月时测**全六项**，其余时候可选四项甚至两项。优先顺序如下：

1. **E2（雌二醇）** 和 **T（睾酮）**：女性化 GAHT 的核心监测指标，所有指南一致要求[^1][^2][^3]
2. **PRL（泌乳素）**：安全监测指标；Endocrine Society 建议周期性监测[^1]，UCSF 和部分专家则倾向仅在出现症状或使用 CPA 时检测[^3][^7]
3. **FSH（卵泡刺激素）** 和 **LH（黄体生成素）**：反映垂体-性腺轴是否被抑制，可作辅助信息，但不是成人 GAHT 常规核心指标
4. **Prog（孕酮）**：标准 GAHT 不依赖孕酮达标；是否加用孕激素及其对乳房发育的帮助，目前证据有争议
...
**特别注意——含炔雌醇的药物（如达英-35）**：常规 E2 检测测的是**雌二醇**，无法识别炔雌醇。使用此类药物时 E2 数值会显得异常偏低，但这**不代表**炔雌醇没有雌激素效应或血栓风险。同时 Endocrine Society 和 UCSF 指南均指出，含炔雌醇的合成雌激素因血栓风险较高且无法通过血清 E2 监测来调节剂量，**不适合作为常规女性化 GAHT 方案**[^1][^3]。
...
> [!IMPORTANT] 重要提示
> 现有数据显示，指南范围内的注射剂量常使中点 E2 高于目标区间[^14]，因此**谷值偏低不一定代表全周期剂量不足**。采血时点和解释逻辑必须匹配。
...
雌二醇是女性化 GAHT 的核心激素，促进**乳房发育、脂肪重新分布**，并维持**骨密度**。它同时通过下丘脑-垂体-性腺轴的负反馈间接压低睾酮[^1]。

> **目标范围**：目前 Endocrine Society / WPATH 常用 E2 目标约 **100–200 pg/mL（约 367–734 pmol/L）**，同时 T < 50 ng/dL（约 1.73 nmol/L）[^1][^2]
...
> **目标范围**：应低于 **50 ng/dL（约 1.73 nmol/L）**[^1][^2][^3]
...
GAHT 中 PRL 常**轻度上升**，需要关注的是**持续明显升高**：
...
- T 已达标时不应仅因 E2 低于 100 pg/mL（约 367 pmol/L）就自动加量[^5]
...
注射雌二醇单药研究显示，多数稳定使用每周注射者可将 T 抑制至 < 50 ng/dL（约 1.73 nmol/L）[^6]；其他给药途径的单雌压雄效果可能有所不同，若口服、舌下或透皮方案 T 持续偏高，应结合风险和医生意见决定是否调整雌激素或加用抗雄。肌注者请先按 [雌低](#雌低) 条目排查间隔和操作问题。
...
> [!IMPORTANT]
> 临床指南普遍认为，仅抑制睾酮而不补充足量雌激素是非常不理想的用药方式——它让人同时失去两种激素的保护[^1]。
...
泌乳素轻度偏高在 GAHT 中十分常见，绝大多数是**良性、可逆的**。但需要能够区分无关紧要的升高和需要进一步检查的情况。
...
- **轻度升高**（约 28.3–94.3 ng/mL，约 600–2000 mIU/L）：可考虑**下调 CPA 剂量或换用其他抗雄药**，然后复评[^7]。CPA 是首要怀疑和首要可调整的对象。若雌激素剂量很高，也可一并考虑适度回调
- **明显升高**（94.3–141.5 ng/mL，约 2000–3000 mIU/L，约参考上限的 4–6 倍）：应考虑**垂体 MRI 和垂体前叶激素检查**[^7]。这一步已超出自我调整范畴，**请务必就医**
